///////////////////////////////////////////////////////////
//  ExpresionOr.cs
//  Implementación de una expresion de comparación lógica OR.
...
namespace scioPersistentLibrary.criterios {
    ...
    /// OR dentro de un criterio de consulta a un motor de persistencia.  
    /// </summary>
    public class ExpresionOr : ExpresionLogica {
        /// <summary>
        /// Constructor de la clase que únicamente pasa los argumentos a la clase base.
        /// </summary>
        public ExpresionOr(ICriterioConsulta left, ICriterioConsulta rigth) : base(left, rigth) {}
        ...
        protected override ICriterion getCriterionNH(ICriterioConsulta left, ICriterioConsulta rigth) {
            return Restrictions.Or(left.getCriterioNH(), rigth.getCriterioNH());
        }
    }
}