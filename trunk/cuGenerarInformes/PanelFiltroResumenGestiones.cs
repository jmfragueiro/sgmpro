...
namespace cuGenerarInformes {
    ...
    /// </summary>
    public partial class PanelFiltroResumenGestiones : UserControl, IPanelFiltros {
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public PanelFiltroResumenGestiones()
        {
            InitializeComponent();
        }
        ...
        private string armaFiltro() {
            ...
            // Filtros de fecha
            sb.Append(string.Format("Inicio >= '{0}' ", ((DateTime) dtpFechaDesde.Value).Date.ToShortDateString()));
            sb.Append(string.Format("and Cierre < '{0}' ",
