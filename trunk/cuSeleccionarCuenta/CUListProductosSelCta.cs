...
namespace cuSeleccionarCuenta {
    ...
    /// </summary>
    public class CUListProductosSelCta : CUListProductos {
        private readonly WinSelectCuenta _ventana;

        /// <summary>
        /// Constructor de la clase que inicializa elementos internos.
        /// </summary>
        public CUListProductosSelCta(WinSelectCuenta ventana) {
            _ventana = ventana;
        }
        ...
        /// </summary>
        protected override PanelListABMV<Producto> crearPanelListado() {
            return new PanelListSeleccion<Producto>(this);
        }
        ...
        public override void alActualizarFila(params object[] parametros) {
            if (_panelListado.getObjetoActual() != null) {
                ...
                _ventana.CriterioCuentas = Criterios.Igual("Producto", _panelListado.getObjetoActual());
            }
        }
