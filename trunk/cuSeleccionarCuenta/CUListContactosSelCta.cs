///////////////////////////////////////////////////////////
//  CUListContactosSelCta.cs
//  Clase de implementación de CUListContactosSelCta.
//  Generated by Fito
...
namespace cuSeleccionarCuenta {
    ...
    /// </summary>
    public class CUListContactosSelCta : CUListContactos {
        private readonly WinSelectCuenta _ventana;

        /// <summary>
        /// Constructor de la clase que inicializa elementos internos.
        /// </summary>
        public CUListContactosSelCta(WinSelectCuenta ventana) {
            _ventana = ventana;
            ColsInvisibles.Remove("Persona");
        }

        /// <summary>
        /// Implementación del método de la interfaz.
        /// </summary>
        protected override PanelListABMV<Contacto> crearPanelListado() {
            return new PanelListSeleccion<Contacto>(this);
        }
        ...
        public override void alActualizarFila(params object[] parametros) {
            if (_panelListado.getObjetoActual() != null) {
                ...
                _ventana.CriterioCuentas = Criterios.Or(
                    Criterios.Igual("Titular", _panelListado.getObjetoActual().Persona),
                    Criterios.Igual("Garante", _panelListado.getObjetoActual().Persona));
            }
        }
