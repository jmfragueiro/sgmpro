///////////////////////////////////////////////////////////
//  PanelListSetABMV.cs
//  Clase de panel de listado de parámetros configurables 
//  genérico para entidades del sistema.
//  Generated by Fito
...
namespace scioControlLibrary {
    public partial class PanelListSet<T> : UserControl, IVistaPanelList where T : EntidadIdentificada<T> {
        /// <summary>
        ...
        /// </summary>
        protected IControladorListSet<T> _controlador;
        ...
        /// </param>
        public PanelListSet(IControladorListSet<T> controlador) {
            try {
                InitializeComponent();
        ...
        /// </returns>
        public IControladorListSet<T> getControlador() {
            return _controlador;
        }
        ...
        /// <summary>
        /// Este método refresca el listado del panel (con los datos que devuelve el 
        /// método list() del controlador del listado -deberia tener datos frescos-).
        /// Además el método permite ocultar las columnas cuyos titulos vienen en el 
        /// List nocols. Debería 'mostrar' cualquier error que pudiese ocurrir y no 
                ...
                if (dgvListado != null) {
                    ...
                    if (dgvListado.CurrentRow != null) {
                        ...
                        if (_controlador != null)
                            _controlador.alActualizarFila(dgvListado.CurrentRow.DataBoundItem);                        
                    }
                }
            } catch (Exception e) {
                Sistema.Controlador.logear("LISTADO-UPDATE-NOK", ENivelMensaje.ERROR, e.ToString());
                throw new DataErrorException("LISTADO-UPDATE-NOK");
            } finally {
                _enProceso = false;
            }
        }
        ...
        /// </param>
        public void setMultiSelect(bool setear) {
        ...
        /// modo de vista del controlador asociado.
        /// </summary>
        public void setModoVista(EModoVentana modo) {
            switch (modo) {
        ...
        /// </summary>
        public virtual void aplicarListPermisos(ToolStrip contenedor, string recurso) {
            try {
        ...
        /// <summary>
        /// Este método responde al botón Edit. Aqui se tiene en cuenta que el
        ...
        /// </param>
        private void PanelListSet_Load(object sender, EventArgs e) {
