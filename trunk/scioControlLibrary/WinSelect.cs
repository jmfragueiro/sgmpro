///////////////////////////////////////////////////////////
//  WinSelect.cs
//  Clase de ventana genérica para seleccion de elementos.
//  Generated by Fito
...
namespace scioControlLibrary {
    ...
    /// </summary>
    public partial class WinSelect<T> : Form, IVistaContenedor where T : EntidadIdentificada<T> {
        /// <summary>
        ...
        /// </summary>
        public WinSelect(string controlador) {
            if (controlador == null)
        ...
        private void btnListo_Click(object sender, EventArgs e) {
            try {
                if (_panel.getObjectActual() != null) {
                    Seleccion = (T) _panel.getObjectActual();
                    Close();
                }
            } catch (Exception ex) {
                Sistema.Controlador.mostrar("DATA_SETNOK", ENivelMensaje.ERROR, ex.ToString(), true);
                Close();
            }
        }
